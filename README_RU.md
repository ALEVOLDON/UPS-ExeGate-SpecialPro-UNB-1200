...
Скрипт автоматически проверит наличие Python, установит все библиотеки из `requirements.txt` и создаст удобный ярлык на Рабочем столе!
...
Убедитесь, что у вас установлен **Python 3.9+** (обязательно с галочкой *Add Python to PATH*).
